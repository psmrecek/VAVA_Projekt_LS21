...
public class LeagueInfoWindow extends javax.swing.JFrame {
    ...
    private void linkButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_linkButtonMouseReleased
        ...
        JOptionPane.showMessageDialog(rootPane, "Link:"+this.league.getMatchList().get(matchesTable.getSelectedRow()).getActiveLink(), "Link na livestream", JOptionPane.INFORMATION_MESSAGE);
